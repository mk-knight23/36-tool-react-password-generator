 ...
 * (WCAG 2.2 §3.2.6 Consistent Help). The link columns give every content page a
 * site-wide inbound link (STANDARDS §5 internal linking).
 */
      ...
      <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6">
        <div className="grid gap-10 md:grid-cols-[1.5fr_1fr_1fr_1fr]">
          ...
          <div className="flex flex-col gap-8">
            <LinkColumn title="Project" links={COMPANY_LINKS} />
            <LinkColumn title="Legal" links={LEGAL_LINKS} />
          </div>
        </div>

        <div className="mt-10 flex flex-col gap-4 border-t border-border pt-6 sm:flex-row sm:items-center sm:justify-between">
          <p className="text-sm text-fg-muted">{CREATOR.footerSentence}</p>
